...
1. [Digital Twins for Software Engineers](books/Digital-Twins-for-Software-Engineers/table-of-contents.md).
   See [pdf version](books/Digital-Twins-for-Software-Engineers/book.pdf).

## Book Chapters

1. [Digital Twins: An Introduction to Beginners](book-chapters/introduction/introduction.md)
1. [Data for Digital Twins: Protocols, Processing, Storage and Integration](book-chapters/data/data.md)
