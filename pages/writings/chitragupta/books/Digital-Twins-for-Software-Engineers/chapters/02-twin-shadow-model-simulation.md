...
[6]. Accounts of the concept's history describe the
same three dimensions -- physical entity, digital counterpart, and the
connection tying them together [7].
...
The aerospace definition describes a twin as an integrated multi-physics,
multi-scale, probabilistic simulation of an as-built vehicle or system,
using the best available physical models, sensor updates and fleet history
to mirror the life of its flying twin -- an ultra-realistic, high-fidelity
conception [14].
...
The manufacturing standard defines a digital twin as a fit-for-purpose
digital representation of an observable manufacturing element, with a means
to enable convergence between the element and its representation at an
appropriate rate of synchronisation [1].
...
[16]. That paper's own analysis of the field is worth
...
simulation capability, and it deliberately keeps only the essential elements
while avoiding use-case-specific characteristics.
...
by integration: the **Digital Twin Prototype (DTP)**, describing the
prototypical artefact and carrying the information needed to produce it; the
**Digital Twin Instance (DTI)**, the as-built counterpart of one specific
physical product, linked to it across its life; and the **Digital Twin
Aggregate (DTA)**, the aggregation of many instances
[6], [17]. Accounts of the
...
[19]. Platform comparisons note that twins present
data as 3D models and interactive dashboards to help stakeholders follow
complex processes [20]. Note the verb in both: it
...
you had a CAD model with a data feed.
...
shadow [21], and mobility twins have been demonstrated with a
human driver deliberately kept in the loop [22]. The
...
metric: the **twinning rate** is the ratio of the frequency of updates from
the physical system to the digital twin, capturing how often
synchronisation occurs, and a low twinning rate leads to outdated twin
states. The companion metric is the **age of twin**, the time elapsed since
the digital state was refreshed [23].
...
make the warning too late to act on [24].
...
in its environment [25]. The framing in the
...
world -- *if you trust it enough to let it do so* [26].
...
question you can now be required to answer [27]. Chapter
...
[28], and a closely related mini-greenhouse setup
with soil-moisture sensors and pumps appears in work on twin lifecycle
management [29]. We are not inventing a toy.
...
definition [16], which requires only that information
...
- *Definitions from outside the taxonomy:* [14] for NASA's
  ...
  [16] for the consolidation exercise,
  [6] with [17],
  [7], [18] and [31]
  for the prototype/instance/aggregate axis.
- *Synchronisation, staleness and lag:* [23] for twinning
  rate and age of twin as measurable metrics, [24]
  for time discrepancy as a problem in its own right,
  [32] for state synchronisation, and
  [33] for fidelity, synchronisation and integration
  treated together.
- *Closing the loop:* [25] on autonomous
  ...
  [27] on what a twin must know before it is trusted to
  act.
- *Classification in practice, on real systems:* [34]
  ...
  [35], [36],
  [37] and [38] are worked
  examples in beer fermentation, shipboard cranes, operating rooms and
  hospital wards respectively.
- *Consulted, not drawn on above:* [19] on
  visualisation as a service (Chapter 11), [20] on
  platforms (Chapter 12), [21] on human-in-the-loop as a named
  twin style, [22] on mobility twins with a human driver,
  [39] and [40] on how other authors
  pin the same definitions, [41] and
  [42] on keeping models current,
  [43] on domain-specific readings of the term,
  [44] and [45] on composing twins
  (Chapter 15), [46] on adoption barriers, and
  [47] on the standards landscape (Chapter 13).
...
[14] Z. Ali, R. Biglari, J. Denil, J. Mertens, M. Poursoltan, and M. K. Traore, "From modeling and simulation to Digital Twin: evolution or revolution?," *SIMULATION*, vol. 100, no. 7, pp. 751-769, 2024.

[15] J. Fitzgerald, C. Gomes, and P. G. Larsen, Eds., *The Engineering of Digital Twins*, Springer International Publishing, 2024.

[16] E. VanDerHorn and S. Mahadevan, "Digital Twin: Generalization, characterization and implementation," *Decision Support Systems*, vol. 145, p. 113524, 2021.

[17] E. Altamiranda, "A System of Systems Foundation for Digital Asset Lifecycle Management," in *Digital Twin: Fundamentals and Applications*, pp. 59-87, Springer Nature Switzerland, 2024.

[18] M. Grieves, "Digital Twins and Their Role in Reengineering Engineering Education," in *Digital Twin: Fundamentals and Applications*, pp. 237-261, Springer Nature Switzerland, 2024.

[19] C. H. Bohlbro, H. D. Macedo, D. Tola, L. Esterle, and P. G. Larsen, "Visualisation in a Digital Twin Context," in *The Engineering of Digital Twins*, pp. 175-188, Springer International Publishing, 2024.

[20] D. Parle, G. Sharma, N. Anand, N. Padgaonkar, D. Stoddart, and D. Malley, "A Comparative Analysis for Harnessing Digital Twin Platforms for Net-Zero Manufacturing," *IEEE Access*, vol. PP, 2024.
...
[22] Z. Wang et al., "Mobility digital twin: Concept, architecture, case study, and future challenges," *IEEE Internet of Things Journal*, vol. 9, no. 18, pp. 17452-17467, IEEE, 2022.

[23] K. Duran et al., "Toward Digital Twin-as-a-Service (DTaaS) Platforms: A Survey on Architecture, Design Requirements, and Performance Metrics," *IEEE Communications Surveys & Tutorials*, vol. 28, pp. 1845-1878, 2026.

[24] M. Frasheri et al., "Addressing time discrepancy between digital and physical twins," *Robotics and Autonomous Systems*, vol. 161, p. 104347, 2023.

[25] L. Esterle, M. Frasheri, and P. G. Larsen, "Autonomous Reconfiguration Enabled by Digital Twins," in *The Engineering of Digital Twins*, pp. 345-362, Springer International Publishing, 2024.

[26] P. G. Larsen, J. Fitzgerald, and C. Gomes, "Engineering Digital Twins for Cyber-Physical Systems," in *The Engineering of Digital Twins*, pp. 3-17, Springer International Publishing, 2024.

[27] N. Zhang, R. Bahsoon, N. Tziritas, and G. Theodoropoulos, "Knowledge Equivalence in Digital Twins of Intelligent Systems," *ACM Transactions on Modeling and Computer Simulation*, vol. 34, no. 1, pp. 1-37, 2024.

[28] E. Kamburjan et al., "GreenhouseDT: An Exemplar for Digital Twins," in *Proceedings of the 19th International Symposium on Software Engineering for Adaptive and Self-Managing Systems*, pp. 175-181, Association for Computing Machinery, 2024.

[29] E. Kamburjan, N. Bencomo, S. L. Tapia Tarifa, and E. B. Johnsen, "Declarative Lifecycle Management in Digital Twins," in *Proceedings of the ACM/IEEE 27th International Conference on Model Driven Engineering Languages and Systems*, pp. 353-363, ACM, 2024.
...
[31] S. Sabri, K. Alexandridis, and N. Lee, Eds., *Digital Twin: Fundamentals and Applications*, Springer Nature Switzerland, 2024.

[32] H. Wu, P. Ji, H. Ma, and L. Xing, "A Comprehensive Review of Digital Twin from the Perspective of Total Process: Data, Models, Networks and Applications," *Sensors*, vol. 23, p. 8306, 2023.

[33] N. Anwer, R. Stark, F. Tao, and J. Erkoyuncu, "Developing and leveraging digital twins in engineering design," *CIRP Annals*, vol. 2025, 2025.

[34] B. J. Oakes et al., "Case Studies in Digital Twins," in *The Engineering of Digital Twins*, pp. 257-310, Springer International Publishing, 2024.
...
[36] Z. Liu, Y. Chu, G. Li, H. P. Hildre, and H. Zhang, "Shipboard crane digital twin: An empirical study on R/V Gunnerus," *Ocean Engineering*, vol. 302, p. 117675, 2024.

[37] S. Burattini et al., "An Ecosystem of Digital Twins for Operating Room Management," in *2023 IEEE 36th International Symposium on Computer-Based Medical Systems (CBMS)*, pp. 770-775, 2023.

[38] R. Sieve, P. Kobialka, L. Slaughter, R. Schlatte, E. B. Johnsen, and S. L. T. Tarifa, "BedreFlyt: Improving Patient Flows through Hospital Wards with Digital Twins," *Electronic Proceedings in Theoretical Computer Science*, vol. 418, pp. 1-15, 2025.

[39] Z. Chen et al., "Service oriented digital twin for additive manufacturing process," *Journal of Manufacturing Systems*, vol. 74, pp. 762-776, 2024.

[40] R. Delhibabu, A. Vodyaho, D. Ignatov, N. Zhukova, and M. Chervoncev, *Synthesis of multi-stakeholder run time dynamic digital twins and dynamic digital twins networks*, 2023.

[41] M. Heithoff, N. Jansen, J. Michael, F. Rademacher, and B. Rumpe, "Model-Based Engineering of Multi-Purpose Digital Twins in Manufacturing," in *Digital Twin: Fundamentals and Applications*, pp. 89-126, Springer Nature Switzerland, 2024.

[42] D. Dittler, P. Lierhammer, D. Braun, T. Muller, N. Jazdi, and M. Weyrich, *An Agent-based Realisation for a continuous Model Adaption Approach in intelligent Digital Twins*, arXiv, 2022.

[43] R. Richstein and K.-U. Schroder, "Characterizing the Digital Twin in Structural Mechanics," *Designs*, vol. 8, no. 1, p. 8, Multidisciplinary Digital Publishing Institute, 2024.

[44] M. S. Gill, J. Zhang, A. Wortmann, and A. Fay, "Toward Automating the Composition of Digital Twins Within System-of-Systems," in *2024 IEEE 29th International Conference on Emerging Technologies and Factory Automation (ETFA)*, pp. 1-4, 2024.

[45] A. Barbone, S. Burattini, M. Martinelli, M. Picone, A. Ricci, and A. Virdis, "Digital Twin Continuum: a Key Enabler for Pervasive Cyber-Physical Environments," in *2024 33rd International Conference on Computer Communications and Networks (ICCCN)*, pp. 1-9, 2024.

[46] M. Perno, L. Hvam, and A. Haug, "Implementation of digital twins in the process industry: A systematic literature review of enablers and barriers," *Computers in Industry*, vol. 134, p. 103558, 2022.

[47] *Summary of IoT, and DT Standards*, Change2Twin project, n.d.
