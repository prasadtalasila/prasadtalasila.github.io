...
runbooks, on-call design, incident-management frameworks. CI/CD mechanics
...
- *TwinOps and DevOps for twins:* [4] and
  [5] on coupling model-based engineering, DevOps and
  twins in one pipeline with runtime traces compared against engineering
  artifacts; [6] and [7] on a
...
[1] Z. Ali, R. Biglari, J. Denil, J. Mertens, M. Poursoltan, and M. K. Traore, "From modeling and simulation to Digital Twin: evolution or revolution?," *SIMULATION*, vol. 100, no. 7, pp. 751-769, 2024.

[2] T. Alskaif et al., *Evolution at the Core of Digital Twin Engineering*, IEEE, 2025.

[3] J. Mertens, S. Klikovits, F. Bordeleau, J. Denil, and . Haugen, *Continuous Evolution of Digital Twins using the DarTwin Notation*, arXiv, 2024.
...
[6] F. Bordeleau, A. Motamedi, and E. Poirier, *A DevOps Approach for the Systematic Development and Evolution of Built Assets Digital Twins*, n.d.

[7] S. Aissat, J. Beaulieu, E. Poirier, A. Motamedi, J. Gascon-Samson, and F. Bordeleau, "A devops framework for the systematic engineering and evolution of digital twins for built assets," *Software and Systems Modeling*, 2025.
...
[9] M. Frasheri, T. Bottjer, P. G. Larsen, L. Esterle, and C. Gomes, "Advanced Digital Twin Services," in *The Engineering of Digital Twins*, pp. 209-222, Springer International Publishing, 2024.
