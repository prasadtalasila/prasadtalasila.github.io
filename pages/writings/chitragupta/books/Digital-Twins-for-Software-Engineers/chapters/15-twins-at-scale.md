...
unified calibration and updating process **able to scale to an entire fleet
of digital twins** [4].

**What it looks like operationally**, without any of the mathematics:

1. Fit a model across the population, using all assets' data together.
2. Derive each asset's parameters as an **offset** from the population --
   typically from a much shorter window than a full campaign needs.
3. Flag assets whose offset is unusual. **Those are either interesting
   assets or bad data**, and both are worth a human.
...
its worked example, identifies **nine key integration challenges that still
need to be addressed** and issues a call to the community to investigate
them [6]. That is a 2025 paper describing open
...
depots. Each vehicle has door systems, HVAC, traction and bogies, all
...
[1] M. Martinelli, J. Zhang, A.-K. Splettstoer, M. Picone, M. Lippi, and A. Wortmann, "Hierarchical Digital Twin Ecosystem for Industrial Manufacturing Scenarios," in *2024 50th Euromicro Conference on Software Engineering and Advanced Applications (SEAA)*, pp. 56-63, 2024.
...
[8] J. M. Bernabe Murcia, E. Canovas, J. Garcia-Rodriguez, A. M. Zarca, and A. Skarmeta, "Decentralised Identity Management solution for zero-trust multi-domain Computing Continuum frameworks," *Future Generation Computer Systems*, vol. 162, p. 107479, 2025.

[9] K. Gleich, S. Behrendt, M. Horger, M. Benfer, and G. Lanza, "An Asset Administration Shell-Based Digital Product Passport as a Gaia-X Service," *Procedia CIRP*, vol. 127, pp. 224-229, 2024.
