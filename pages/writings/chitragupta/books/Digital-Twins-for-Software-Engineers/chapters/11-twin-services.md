...
The purpose is not decoration and it is not marketing. The overall objective
is to make it easier for humans to extract the desired information from
data, and in a twin specifically it lets users get the most value from the
models, data and analytic services the twin offers -- presenting the state
and dynamics of the system, augmented with the results of simulation,
analysis and prediction [1]. Two consequences of
...
target group beyond the data engineer to workers in the field with a
non-technical background [1]. That is a real
...
thing stops, you had a CAD model with a data feed.
...
[6] M. Frasheri, T. Bottjer, P. G. Larsen, L. Esterle, and C. Gomes, "Advanced Digital Twin Services," in *The Engineering of Digital Twins*, pp. 209-222, Springer International Publishing, 2024.
...
[11] J. Robles, C. Martin, and M. Diaz, "OpenTwins: An open-source framework for the development of next-gen compositional digital twins," *Computers in Industry*, vol. 152, p. 104007, 2023.
...
[15] J. Li, J. Grubel, A. Nadi, M. Snelder, B. van Arem, and J. Gao, *Digital Twin Federation for Urban Mobility Assessment: A Functional Architecture for Low-Car Transformations in the Netherlands*, Elsevier, Forthcoming, 2025.
